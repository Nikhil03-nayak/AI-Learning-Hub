...
const FlashcardManager = ({ documentId }) => {
  ...
  const handleReview = async (index) => {
    const currentCard = selectedSet?.cards[currenCardIndex];
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium  rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
            >
              <ChevronLeft
            ...
            <div className="px-4 py-2 bg-slate-100 rounded-lg border border-slate-100">
      ...
      return (
        <div className="flex flex-col items-center justify-center px-16 py-16">
          ...
          <p className="text-sm text-slate-500 mb-8 text-center max-w-sm">
            Generate flashcards from your document to start your learning
            journey
          </p>
          <button
            onClick={handleGenerateFlashcards}
            disabled={generating}
            className="group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/30 active:scale-95 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
          >
            {generating ? (
              <>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              ...
              {(flashcardSets?.length || 0) === 1 ? "set" : "sets"} available
            </p>
          </div>
          <button
            onClick={handleGenerateFlashcards}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {flashcardSets?.map((set) => (
            ...
            >
              ...
              {/* Content Inside the Flashcard Set */}
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              disabled={deleting}
              className="px-5 h-11 bg-linear-to-r from-rose-500 to-red-500 hover:from-rose-500 hover:to-red-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/30 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
            >
              {deleting ? (
